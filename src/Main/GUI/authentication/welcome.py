...
class WelcomeScreen(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        ctk.CTkButton(content, text="Log In", width=300, height=40, command=lambda: controller.show_frame("LoginScreen")).pack(pady=10)
        ctk.CTkButton(content, text="Sign Up", width=300, height=40, command=lambda: controller.show_frame("SignUpScreen")).pack(pady=10)